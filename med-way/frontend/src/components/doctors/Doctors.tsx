...
export default function Doctors() {
    ...
    const doctorList: {name: string, imageURL: string, description: string}[] = [
        {
            name: 'Молодан Олександр Вікторович',
            imageURL: '/doctors/molodan.jpg',
            description: 'Доцент кафедри кардіології ЗМАПО, лікар-кардіолог вищої кваліфікаційної категорії з багаторічним досвідом наукової, педагогічної та клінічної роботи. У 1997 році захистив кандидатську дисертацію, у 2007 році затверджений у вченому званні доцента. Автор 92 наукових праць, 5 навчально-методичних посібників та 8 деклараційних патентів України на винаходи.'
        },
        {
        ...
        {
            name: 'Пасечнік Олена Андріївна',
            imageURL: '/doctors/pasechnik.jpg',
            description: 'Лікар-кардіолог вищої кваліфікаційної категорії з багаторічним клінічним досвідом. Спеціалізується на діагностиці та лікуванні серцево-судинних захворювань, профілактиці ускладнень та веденні пацієнтів із хронічною кардіологічною патологією. У роботі поєднує доказову медицину з індивідуальним підходом, застосовуючи сучасні міжнародні протоколи лікування для досягнення стабільних і довготривалих результатів.'
        },
        {
